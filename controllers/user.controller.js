...
export const changePassword = async (req, res) => {
  try {
    ...
    // chech of the new password is not the same as the current password or any of the old passwords
    if (
...
<head>
    ...
    <style>
        ...
        body { 
            margin:0; padding:0; background:#f8fafc; font-family:'Inter',system-ui,sans-serif; 
            color: #1f2937;
        }
        .email-container { 
            max-width: 620px; 
...
<body>
    <div class="email-container">
        ...
        <div class="content">
            <p class="greeting">Hey ${user.fullName || "there"},</p>
            
            <p class="message">
                You requested to reset your password for the Inventory Dashboard.<br><br>
        ...
        <div class="footer">
            <p><strong>Therabridge</strong> • Kigali, Rwanda</p>
            <p>Need help? Reach out to our support team anytime.</p>
            <p style="margin-top: 18px; font-size: 13px;">© ${new Date().getFullYear()} Therabridge. All rights reserved.</p>
        </div>
    </div>
</body>
</html>`;
