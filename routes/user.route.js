...
import { getTherapistById, getTherapistByUsername } from "../controllers/profile.controller.js";
...
router.get("/therapists/username/:username", authMiddleware, getTherapistByUsername);
